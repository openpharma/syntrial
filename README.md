...
[![R-CMD-check](https://github.com/openpharma/syntrial/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/openpharma/syntrial/actions/workflows/R-CMD-check.yaml)
...
Clinical trial data are expected to be in [SDTM](https://www.cdisc.org/standards/foundational/sdtm)-like format without RELREC tables. Adaptation to [ADAM](https://www.cdisc.org/standards/foundational/adam) datasets should be straightforward.
